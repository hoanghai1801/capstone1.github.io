...
@section('slider')
    <div class="slider-home">
        <div class="slider-text">
            ...
            <p class="text-content">Our travel agency is ready to offer you an exciting vacation that is designed to fit your
                own needs and wishes. Whether it's an exotic cruise or a trip to your favorite resort, you will surely have
            ...
            <div class="search-tour-container">
                <div class="search-tour-depart">
                    ...
                    <div class="search-tour-depart-body">
                        <input type="date" placeholder="Choose the date" class="search-tour-depart-date">
                    </div>
                </div>
                <div class="search-tour-to">
                    <h4 class="search-tour-depart-header">
